...
<head>
    ...
    <?php
        ...
        $hasPermission = getColumn('admin', 'user', "email = '$email'", $conn);
        
        $passport_requests_count = 0;
        $pass_requests = [];
        $users = [];
        $rooms = [];
        $cities = [];
        ...
        if(isset($_GET['actionPR']))
        {
            ...
            {
                $resultMsg = $conn->error;
            }
            
            echo "  <script>
                            console.log('{$resultMsg}');
                            //location.replace('/adminka');
                        </script>";
        }
        ...
        if(isset($_GET['action']))
        {
            ...
            //rooms
            else if($_GET['action'] == 'add_new_room') 
            {
                $hotelID = $_GET['hotelID'];
                $roomtypeID = $_GET['roomtypeID'];
                $countSubRooms = $_GET['countSubRooms'];
                $countUsers = $_GET['countUsers'];
            ...
            //city
            else if($_GET['action'] == 'add_new_city')
            {
                $cityName = $_GET['Name'];
                $cityCountry = $_GET['Country'];
                
                $result = addRow("Name, Country", "'{$cityName}', '{$cityCountry}'", "city", $conn);
            }
            else if($_GET['action'] == 'delete_city') 
            {
                $cityID = $_GET['cityID'];
            ...
            //airports
            else if($_GET['action'] == 'add_new_airport')
            {
                $Name = $_GET['Name'];
                $cityID = $_GET['CityID'];
            ...
            else if($_GET['action'] == 'delete_airport') 
            {
            ...
            //hotel
            else if($_GET['action'] == 'add_new_hotel')
            {
                $id = $_GET['HotelID'];
                $Name = $_GET['Name'];
                $cityID = $_GET['CityID'];
            ...
            else if($_GET['action'] == 'delete_hotel')
            {
                $hotelID = $_GET['hotelID'];
            ...
            //roomtype
            else if($_GET['action'] == 'add_new_roomtype')
            {
                $id = $_GET['RoomtypeID'];
                $Name = $_GET['Name'];
            ...
            else if($_GET['action'] == 'delete_roomtype')
            {
                $roomtypeID = $_GET['roomtypeID'];
            ...
            //-----planes-----
            //plane
            else if($_GET['action'] == 'add_new_plane')
            {
                $id = $_GET['PlaneID'];
                $Name = $_GET['Name'];
                $Count = $_GET['PlaneCount'];
                $TypeID = $_GET['TypeID'];
                            
                $result = addRow("id, Name, Count, Type_idType", "{$id}, '{$Name}', {$Count}, {$TypeID}", "plane", $conn);
            }
            else if($_GET['action'] == 'delete_plane')
            {
            ...
            //planetype
            else if($_GET['action'] == 'add_new_planetype')
            {
                $id = $_GET['PlanetypeID'];
                $Name = $_GET['Name'];
            ...
            else if($_GET['action'] == 'delete_planetype')
            {
            ...
            //-----flights-----
            else if($_GET['action'] == 'add_new_flight')
            {
                $reisNumber = $_GET['reisNumber'];
                $reisRC = $_GET['reisRC'];
                $reisTimeFrom = $_GET['timeFrom'];
                $reisTimeTo = $_GET['timeTo'];
                $planeID = $_GET['planeID'];
                $airportFromID = $_GET['airportFromID'];
                $airportToID = $_GET['airportToID'];
                $price = $_GET['Price'];
            ...
            else if($_GET['action'] == 'delete_flight')
            {
                        ...
                        <?php
                            ...
                            for($i = 0; $i < count($pass_requests); $i++)
                            {
                                echo "  <tr>
                                            ...
                                            <td>
                                                <form method='get'>
                                                    <button name='actionPR' value='1,{$pass_requests[$i]['id']}'>Accept</button>
                                                    <button name='actionPR' value='0,{$pass_requests[$i]['id']}'>Decline</button>
                                                    <input type='text' name='passId' style='display: none' value='{$pass_requests[$i]['PassID']}'>
                                                    <input type='text' name='userId' style='display: none' value='{$pass_requests[$i]['User_id']}'>
                                                </form>
